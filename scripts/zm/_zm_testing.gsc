...
{
	// self thread m_lui::show_shader_for_time( "t7_hud_zm_powerup_deathmachine", 5, 0, 320, 256, 256 );
	// self thread m_lui::show_shader_for_time( "t7_hud_zm_powerup_deathmachine", 5, 100, 320, 128, 128 );
}
